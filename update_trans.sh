...
cp plugins/redmine_agile/config/locales/zh-TW.yml $REDMINE_PATH/plugins/redmine_agile/config/locales/zh-TW.yml
cp plugins/redmine_checklists/config/locales/zh-TW.yml $REDMINE_PATH/plugins/redmine_checklists/config/locales/zh-TW.yml
